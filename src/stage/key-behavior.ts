...
class KeyBehavior {
  ...
  constructor (readonly stage: Stage) {
    ...
    this.domElement.addEventListener('touchstart', this._focusDomElement, {passive: true})  // TODO
  ...
  dispose () {
    ...
    this.domElement.removeEventListener('touchstart', this._focusDomElement)  // TODO
